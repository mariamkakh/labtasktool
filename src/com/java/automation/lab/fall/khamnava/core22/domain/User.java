...
public class User extends AbstractUser {
    private HashSet<UserAction> action = new HashSet<UserAction>(Arrays.asList(UserAction.ADD_TASK,
            ...
            UserAction.EDIT_TASK, UserAction.WATCH_SPRINT, UserAction.WATCH_TASK, UserAction.ASSIGN_TASK));

    public User(Info significantInfo, UserRole role, List<VisualBoard> visualBoard) {
    ...
    public boolean equals(Object that) {
        ...
        return getSignificantInfo().equals(((User) that).getSignificantInfo()) &&
                ...
                this.action.equals(((User) that).action);
    }
