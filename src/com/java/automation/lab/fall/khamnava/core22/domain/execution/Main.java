package com.java.automation.lab.fall.khamnava.core22.domain.execution;
...
import com.java.automation.lab.fall.khamnava.core22.domain.exception.InvalidPathException;
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(FileUtil.read("E:\\java\\core2\\tool\\src\\com\\java\\automation\\lab" +
                    "\\fall\\khamnava\\core22\\domain\\resources\\Comment.dict"));
        ...
        try {
            System.out.println(FileUtil.read("E:\\java\\core2\\tool\\src\\com\\java\\automation\\lab" +
                    "\\fall\\khamnava\\core22\\domain\\resources\\Info.dict"));
        } catch(InvalidPathException ex){
            System.out.println("This file doesn't exists");
        }
        ...
        try {
            ...
            System.out.println(FileUtil.read("E:\\java\\core2\\tool\\src\\com\\java\\automation\\lab" +
                    "\\fall\\khamnava\\core22\\domain\\resources\\Action.dict"));
        } catch(EmptyListException ex){
        ...
        System.out.println(FileUtil.read("E:\\java\\core2\\tool\\src\\com\\java\\automation\\lab" +
                "\\fall\\khamnava\\core22\\domain\\resources\\Reminder.dict"));
        } catch(EmptyListException ex){
